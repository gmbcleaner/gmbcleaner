...
export default function LoginPage() {
  ...
  const handleForgotPassword = async () => {
    ...
    if (!/@/.test(email)) {
      setError('Password reset is sent to your email. Enter the email you used to sign up to reset your password.');
      return;
    }
        ...
        <Card className="shadow-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col gap-4">
              ...
              <Button type="button" variant="outline" size="lg" className="w-full" onClick={handleGoogle} disabled={googleLoading}>
