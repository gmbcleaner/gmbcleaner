...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center overflow-y-auto bg-gradient-to-b from-slate-50 to-white px-4 py-8">
        ...
        <Card className="shadow-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col gap-4">
              <Button type="submit" size="lg" className="w-full bg-gradient-to-r from-teal-500 to-sky-500 text-white hover:from-teal-600 hover:to-sky-600" disabled={submitting || googleLoading}>
              ...
              <Button type="button" variant="outline" size="lg" className="w-full" onClick={handleGoogle} disabled={submitting || googleLoading}>
