...
export default function DashboardHomePage() {
  ...
  const completionRate =
    stats.totalOrders > 0
      ? Math.round((stats.completedItems / (stats.totalOrders * 5 || 1)) * 100)
      : 0;
        ...
        <Card className="lg:col-span-2 shadow-card">
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            <div>
              ...
              <CardDescription>Your latest review dispute orders</CardDescription>
            </div>
                    ...
                    >
                      <div
                        className={`mt-1 h-2 w-2 shrink-0 rounded-full ${
                          notif.is_read ? 'bg-slate-300' : 'bg-teal-500'
                        }`}
                      />
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Overall progress across all your orders</CardDescription>
              </div>
